...
function init() {
  ...
  $("#lMaquina").addClass("active bg-green");
...
function mostrar_pagos(idpago_servicio, id_maquinaria) {
  ...
  $.post("../ajax/servicio_maquina.php?op=mostrar_pagos", { idpago_servicio: idpago_servicio }, function (e, status) {
...
function ver_modal_vaucher(comprobante,numero_operacion) {
  ...
  if (DocExist(`dist/docs/servicio_maquina/comprobante_pago/${comprobante}`) == 200) {
    $("#iddescargar").attr("href","../dist/docs/servicio_maquina/comprobante_pago/"+comprobante).attr("download", `N° Operación-${numero_operacion}  - ${dia_actual}`).removeClass("disabled");
...
function mostrar_factura(idfactura) {
  ...
  $.post("../ajax/servicio_maquina.php?op=mostrar_factura", { idfactura: idfactura }, function (e, status) {
...
function ver_modal_factura(comprobante,numero_operacion) {
  ...
  $('#ver_fact_pdf_f').html(doc_view_extencion(comprobante, 'servicio_maquina', 'comprobante_servicio', '100%', '550'));

  if (DocExist(`dist/docs/servicio_maquina/comprobante_servicio/${comprobante}`) == 200) {
    $("#iddescargar_f").attr("href","../dist/docs/servicio_maquina/comprobante_servicio/"+comprobante).attr("download", `Fect N°-${numero_operacion}  - ${dia_actual}`).removeClass("disabled");
