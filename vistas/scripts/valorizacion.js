...
var host = window.location.host == 'localhost'? `http://localhost/admin_integra/dist/docs/valorizacion/documento/` : `${window.location.origin}/dist/docs/valorizacion/documento/` ;
...
function init() {
  ...
  $("#lValorizacion").addClass("active bg-green");
