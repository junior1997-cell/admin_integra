  ...
  if (!isset($_SESSION["nombre"])){
    ...
    <html lang="es">
      <head>
        ...
        <title>Admin Integra | Resumen Activos Fijos</title>       
            ...
            <div class="content-wrapper" >
              ...
              <section class="content-header">
                <div class="container-fluid">
                  <div class="row mb-2">
                    <div class="col-sm-6">
                      <h1 class="m-0 nombre-insumo">Resumen de Activos Fijos</h1>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <form id="form-materiales" name="form-materiales" method="POST">
                          <div class="card-body">
                            <div class="row" id="cargando-3-fomulario">
                              ...
                              <!-- barprogress -->
                              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: 20px;">
                                <div class="progress" id="barra_progress_activo_fijo_div">
